...
class GsapComponent extends HTMLElement {
  constructor() {
    super();
      ...
      '(min-width: 769px)': () => {
        ...
        imgs.forEach((_, index) => {
          ...
          if (nextImage) {
            sectionTimeline
              .to(
                this.shadowRoot.host, // background color change applies to host
                {
...
customElements.define('gsap-component', GsapComponent);